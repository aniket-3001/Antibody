...
function Badge({ className, variant = "default", ...props }) {
  const variants = {
    default: "border-transparent bg-[var(--color-brand)] text-[var(--color-surface)] hover:opacity-80",
    secondary: "border-[var(--color-line)] bg-[var(--color-surface-2)] text-[var(--color-ink)] hover:opacity-80",
