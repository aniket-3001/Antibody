    ...
    <div className="flex flex-col gap-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-[15px] text-[var(--color-body)]">
          Not on the Chrome Web Store yet - load it as an unpacked developer extension directly from your local folder (get it from <a href={REPO_URL} target="_blank" rel="noopener noreferrer" className="text-[var(--color-brand)] font-bold hover:underline">GitHub</a>).
        </p>
      </div>
